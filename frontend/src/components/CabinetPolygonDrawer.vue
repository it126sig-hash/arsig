          ...
          <div class="flex items-center gap-3">
            ...
            <div class="flex items-center gap-1.5 ml-2 border-l border-white/20 pl-3">
              <button
                ...
                :class="['px-2 py-1 text-[10px] font-semibold rounded-md transition-colors', drawingMode === 'polygon' ? 'bg-orange-500 text-white shadow-sm' : 'bg-white/20 text-white/70 hover:bg-white/30']"
              >
                Manual
              </button>
              <button
                ...
                :class="['px-2 py-1 text-[10px] font-semibold rounded-md transition-colors', drawingMode === 'rect' ? 'bg-orange-500 text-white shadow-sm' : 'bg-white/20 text-white/70 hover:bg-white/30']"
              >
                Persegi
              </button>
            </div>
